---------------------------------------------------------------------------------------------------
-- func: getmodelsize <optional MobID>
-- desc: Used to get a mob's entity model size for testing.
...
function onTrigger(player, target)
    ...
    -- set model size
    local modelSize = targ:getModelSize()
    player:PrintToPlayer(string.format("%s's modelSize: %u", targ:getName(), modelSize))
end
