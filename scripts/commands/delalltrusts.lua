---------------------------------------------------------------------------------------------------
-- func: delalltrusts
-- desc: dels all trust spells to the given target. If no target then to the current player.
---------------------------------------------------------------------------------------------------
...
function error(player, msg)
    ...
    player:PrintToPlayer("!delalltrusts {player}")
end
...
function onTrigger(player, target)
    ...
    player:PrintToPlayer(string.format("%s no longer has any trusts.", targ:getName()))
end
