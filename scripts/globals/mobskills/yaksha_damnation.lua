---------------------------------------------
--  Yaksha Damnation
--  Description: AOE Damage. Additiopnal effect: Magic Defense Down, and Defense Down
--  Wipes shadows
---------------------------------------------
...
function onMobWeaponSkill(target, mob, skill)
    ...
    MobPhysicalStatusEffectMove(mob, target, skill, tpz.effect.DEFENSE_DOWN, 50, 0, 120)
    MobPhysicalStatusEffectMove(mob, target, skill, tpz.effect.MAGIC_DEF_DOWN, 50, 0, 120)
