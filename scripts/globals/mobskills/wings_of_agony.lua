...
-- Wings of Agony
-- Physical AOE damage. 
-- Addittional effect: Nightmare Sleep and Paralysis
---------------------------------------------------
...
function onMobWeaponSkill(target, mob, skill)
    ...
    MobPhysicalStatusEffectMove(mob, target, skill, tpz.effect.PARALYSIS, 20, 0, 60, false, params)
    MobPhysicalStatusEffectMove(mob, target, skill, tpz.effect.SLEEP_I, 1, 3, 90, false, params)
