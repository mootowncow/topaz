...
--  Sniper Shot
--
--  Description: Deals damage to target in a ranged attack.
--  Additional effect: INT Down
--  Type: Ranged
...
function onMobWeaponSkill(target, mob, skill)
    ...
    MobPhysicalStatusEffectMove(mob, target, skill, tpz.effect.INT_DOWN, 33, 3, 60)
    return dmg
end
