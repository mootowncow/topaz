...
function onMobWeaponSkill(target, mob, skill)
    ...
    MobPhysicalStatusEffectMove(mob, target, skill, tpz.effect.CURSE_I, 50, 0, 60)
    MobPhysicalStatusEffectMoveSub(mob, target, skill, tpz.effect.BIO, 48, 3, 180, 0, 15, 3)
    target:setEffectUndispellable(tpz.effect.CURSE_I)
