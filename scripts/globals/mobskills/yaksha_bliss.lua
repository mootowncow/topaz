...
function onMobWeaponSkill(target, mob, skill)
    ...
    MobPhysicalStatusEffectMove(mob, target, skill, tpz.effect.ATTACK_DOWN, 25, 0, 120)
    MobPhysicalStatusEffectMove(mob, target, skill, tpz.effect.MAGIC_ATK_DOWN, 25, 0, 120)
