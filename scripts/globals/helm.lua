    ...
    [tpz.helm.type.MINING] =
    {
        ...
        zone =
        {
            ...
            [tpz.zone.YUGHOTT_GROTTO] =
            {
                ...
                points =
                {
                    -- {-272.354,  -0.378,  -78.058}, Double spawn by another point?
                    {-269.857,  -0.812,  -71.180}, -- {R}D-9
                    {-245.622,  -1.350,  -86.981}, -- {R}D-10 Can be made closer to DAT
                    {-224.477,  -1.165, -112.948}, -- {R}E-10 Can be made closer to DAT
                    -- {-181.213,  -1.156, -111.072}, Not on DAT map
                    -- {-175.728,  -1.133,  -95.682}, Not on DAT map
                    {-141.144,  -1.407,  -97.973},
                    -- {-124.625,  -0.655,  -73.322}, Not on DAT map
                    {-122.534,  -0.804,   -5.241},
                    -- {-117.765,  -1.018,   -5.093}, Double spawn by another point?
                    { -85.180,  -0.821,  -37.458},
                    { -72.101,  -1.821,  -28.295}, -- {R}G-9
                    { -33.193,  -0.962,   -7.588},
                    { -25.004,  -1.122,   30.867},
                    -- { -22.575,  -0.848,   34.002}, Double spawn by another point?
                    { -16.529,  -1.251,  -62.637},
                    {  12.319,  -1.143,   38.814},
                    -- {  15.087,  -1.349,  -41.581}, -- {R}H-9 Not on DAT map
                    -- {  25.143,  -1.219,   21.085}, Not on DAT map
                    {  69.955,  -3.219,   27.781},
                    -- {  70.715,  -3.235,   27.636}, Not on DAT map
                    -- { 104.726, -13.868,   47.164}, Not on DAT map
                    -- { 140.836, -13.275,  131.468}, -- {R}I-7 Not on DAT map
                    { 148.312, -13.154,   55.118}, -- Can be made closer to DAT
                    -- { 175.534, -12.809,   36.799}, Not on DAT map
                    { 183.111, -13.205,  134.862},
                    -- { 213.887, -13.077,  138.546}, Not on DAT map
                    { 218.911, -13.094,   47.544},
                    -- { 258.910, -13.445,  122.106}, Not on DAT map
                    -- { 280.000, -21.813,  169.367}, Not on DAT map
                    { 310.232, -24.639,  161.209}, -- Can be made closer to DAT
                    -- { 312.119, -24.797,  212.536}, Not on DAT map
                    -- { 330.931, -24.900,  239.451}, Not on DAT map
