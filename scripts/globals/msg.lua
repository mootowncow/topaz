...
tpz.msg.basic =
{
    ...
    HIT_ABSORBS_HP          = 373,-- The<player> hits<target>.<target>recovers..hit points !
    ...
    MAGIC_FAIL             = 114, -- <caster> casts <spell> on <target>, but the spell fails to take effect (BLU phys spell miss)
    ...
    EFFECTS_DISAPPEAR_2    = 790, -- {id=792,en="${actor} uses ${spell}.${lb}${number} of ${target}'s effects disappears!",color=56,suffix="effects disappears"}, Dispel if > 1 dispel effect
