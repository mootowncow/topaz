...
function onUseWeaponSkill(player, target, wsID, tp, primary, action, taChar)
    ...
    local params = {}
    params.numHits = 4
    params.ftp100 = 2.1875 params.ftp200 = 2.3 params.ftp300 = 2.5
    params.str_wsc = 0.0 params.dex_wsc = 0.25 params.vit_wsc = 0.0 params.agi_wsc = 0.25 params.int_wsc = 0.0 params.mnd_wsc = 0.0 params.chr_wsc = 0.0
