...
function onSpellCast(caster, target, spell)
    ...
    DeleteStormEffects(target, tpz.effect.THUNDERSTORM_II)
    target:addStatusEffect(tpz.effect.THUNDERSTORM_II, power, 0 , duration)

    return tpz.effect.THUNDERSTORM_II
end
