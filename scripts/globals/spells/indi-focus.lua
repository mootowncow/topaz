...
function onSpellCast(caster, target, spell)
    ...
    target:addStatusEffectEx(tpz.effect.COLURE_ACTIVE, tpz.effect.COLURE_ACTIVE, 13, 3, 180, tpz.effect.GEO_MAGIC_ACC_BOOST, power, tpz.auraTarget.ALLIES, tpz.effectFlag.AURA)
