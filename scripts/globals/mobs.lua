...
tpz.mob.ENTITYFLAGS =
{
    ...
    BIT1          = 0x00000002,
    BIT2          = 0x00000004,
    HIDE_NAME     = 0x00000008, -- bit 3

    BIT4          = 0x00000010,
    CALL_FOR_HELP = 0x00000020, -- bit 5
    BIT6          = 0x00000040,
    BIT7          = 0x00000080,

    HIDE_HP       = 0x00000100, -- bit 8
    BIT9          = 0x00000200,
    BIT10         = 0x00000400,
    UNTARGETABLE  = 0x00000800, -- bit 11
...
tpz.mob.NAMEVIS =
{
    ...
    INFO_FLAG     = 0x00000001,
    BIT1          = 0x00000002,
    BIT2          = 0x00000004,
    UNTARGETABLE  = 0x00000008,

    BIT4          = 0x00000010,
    HIDE_NAME     = 0x00000020,
    BIT6          = 0x00000040,
