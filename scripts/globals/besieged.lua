...
function getISPItem(i)
    local IS_item =
    {
        ...
        --[36865] = {id = 3307, price = 5000}, -- heat capacitor (Come from Treasure Caskets)
        --[40961] = {id = 3308, price = 5000}, -- power cooler (Come from Treasure Caskets)
        --[45057] = {id = 3309, price = 5000}, -- barrage turbine (Come from Treasure Caskets)
        --[53249] = {id = 3311, price = 5000}, -- galvanizer (Come from Treasure Caskets)
