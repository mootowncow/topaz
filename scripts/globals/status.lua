...
tpz.effect =
{
    ...
    ILLUSION                 = 258,
    ENCUMBRANCE_I            = 259,
    OBLIVISCENCE             = 260, -- Restricts subjob, used for mob TP moves and salvage
    IMPAIRMENT               = 261,
    OMERTA                   = 262,
    DEBILITATION             = 263,
    PATHOS                   = 264,
    FLURRY                   = 265, -- Flurry Nyzul Pathos
    CONCENTRATION            = 266,
    ALLIED_TAGS              = 267,
    SIGIL                    = 268,
    LEVEL_SYNC               = 269,
    ...
    COMMITMENT               = 579,
    GEO_HASTE                = 580,
    FLURRY_II                = 581, -- Flurry Spell effect
    CONTRADANCE              = 582,
    APOGEE                   = 583,
    ENTRUST                  = 584,
    COSTUME_II               = 585,
...
tpz.mobMod =
{
    ...
    BLOCK               = 103, -- Gets the shield size of the mob, allowing them to block. (3 = kite)
