...
zones[tpz.zone.GARLAIGE_CITADEL] =
{
    text =
    {
        ...
        FIRST_GATE_OPENING          = 7286,  -- The first banishing gate begins to open...
        SECOND_GATE_OPENING         = 7287,  -- The second banishing gate begins to open...
        THIRD_GATE_OPENING          = 7288,  -- The third banishing gate begins to open...
        FIRST_GATE_CLOSING          = 7289,  -- The first banishing gate starts to close.
        SECOND_GATE_CLOSING         = 7290,  -- The second banishing gate starts to close.
        THIRD_GATE_CLOSING          = 7291,  -- The third banishing gate starts to close.
