...
function onTrigger(player, npc)
    local stock =
    {
        ...
        5096,  63740,    -- Scroll of Boost-VIT
        5099,  67500,    -- Scroll of Boost-MND
        5097,  75680,    -- Scroll of Boost-AGI
        5100,  71900,    -- Scroll of Boost-CHR
        5094,  79804,    -- Scroll of Boost-STR
        5098,  84461,    -- Scroll of Boost-INT
        5095,  89613,    -- Scroll of Boost-DEX
