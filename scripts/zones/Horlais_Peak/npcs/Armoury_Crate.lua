...
local loot =
{
    ...
    {
        {
            {itemid = 13553, droprate = 200}, -- blitz Ring
            {itemid = 13554, droprate = 200}, -- aegis Ring
        ...
        {
            {itemid = 4896, droprate = 200}, -- firespirit
            {itemid = 4751, droprate = 200}, -- erase
            {itemid = 4714, droprate = 200}, -- phalanx
            {itemid = 4874, droprate = 200}, -- absorb-str
            {itemid = 788,  droprate =  25}, -- peridot
            {itemid = 792,  droprate =  25}, -- pearl
            {itemid = 772,  droprate =  25}, -- green rock
            {itemid = 811,  droprate =  25}, -- ametrine
            {itemid = 748,  droprate =  25}, -- gold beastcoin
            {itemid = 749,  droprate =  25}, -- mythril beastcoin
            {itemid = 771,  droprate =  25}, -- yellow rock
            {itemid = 0,    droprate =  25}, -- nothing
        },
        {
            {itemid = 4896, droprate = 200}, -- firespirit
            {itemid = 4751, droprate = 200}, -- erase
        ...
        {
            {itemid = 4896, droprate = 16}, -- firespirit
            {itemid = 4714, droprate = 16}, -- icespikes
            {itemid = 4874, droprate = 16}, -- refresh
            {itemid = 4947, droprate = 16}, -- utsusemi ni
            {itemid = 4751, droprate =  16}, -- vile elixir
            {itemid = 772,  droprate =  16}, -- green rock
            {itemid = 775,  droprate =  16}, -- black rock
            {itemid = 770,  droprate =  16}, -- blue rock
            {itemid = 769,  droprate =  16}, -- red rock
            {itemid = 774,  droprate =  16}, -- purple rock
            {itemid = 776,  droprate =  16}, -- white rock
            {itemid = 771,  droprate =  16}, -- yellow rock
            {itemid = 773,  droprate =  16}, -- translucent rock
            {itemid = 4172, droprate =  16}, -- reraiser
            {itemid = 699,  droprate =  16}, -- oak log
            {itemid = 701,  droprate =  16}, -- rosewood log
            {itemid = 748,  droprate =  16}, -- gold beastcoin
            {itemid = 749,  droprate =  16}, -- mythril beastcoin
            {itemid = 792,  droprate =  16}, -- pearl
            {itemid = 798,  droprate =  16}, -- Turquoise
            {itemid = 808,  droprate =  16}, -- Goshenite
            {itemid = 793,  droprate =  16}, -- Black pearl
            {itemid = 815,  droprate =  16}, -- sphene
            {itemid = 790,  droprate =  16}, -- garnet
            {itemid = 811,  droprate =  16}, -- ametrine
