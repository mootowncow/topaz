...
enum ALLEGIANCETYPE
{
    ...
    ALLEGIANCE_MOB_TWO   = 7, // TODO: Hostile to mobs AND players(Mising logic everywhere I think)
};
...
public:
    ...
    bool            trustProgressUpdateFlag;             // Flag to send custom mob trustprogress packet..
